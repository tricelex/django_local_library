...
class RenewBookFormTest(TestCase):
    def test_renew_form_date_field_label(self):
        form = RenewBookForm()
        self.assertTrue(
            form.fields["renewal_date"].label is None or form.fields["renewal_date"]
        )
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        test_user1 = User.objects.create_user(
            username="testuser1", password="qwertyuhdn1"
        )
        test_user2 = User.objects.create_user(
            username="testuser2", password="qwertyuhdn1"
        )

        test_user1.save()
        test_user2.save()

        test_author = Author.objects.create(first_name="Jon", last_name="Snow")
    ...
    def test_logged_in_uses_correct_template(self):
        login = self.client.login(username="testuser1", password="qwertyuhdn1")
        response = self.client.get(reverse("my-borrowed"))
